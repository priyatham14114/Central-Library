                    ...
                    if (oNewUserPassword === oNewUserConfirmPassword) {
                        ...
                        oBinding.requestContexts().then(function (aContexts) {  //requestContexts is called to get the contexts (matching records) from the backend.
                            ...
                            if (aContexts.length > 0) {
                                ...
                                othis.oSignUpDialog.close()
                                othis.getView().byId("idSignUpUserName").setValue("")
                                othis.getView().byId("idSignUpUserIdVal").setValue("")
                                othis.getView().byId("idSignUpUserPassword").setValue("")
                                othis.getView().byId("idSignUpUserConfirmPasswordval").setValue("")
